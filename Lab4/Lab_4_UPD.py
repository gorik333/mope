    ...
    def student_crit_check(self):
        ...
        for i in inmb:
            if i == 0:
                ...
                eq_str += " + b" + str(i) + " * " + "x" + str(i)

        eq_str2 = "y="

        for i in inmb:
            if i == 0:
                eq_str2 += str(round(b[i], 3))
            else:
                print(round(b[i], 3))
                eq_str2 += " + " + str(round(b[i], 3)) + " * " + "x" + str(i)
        print(eq_str)
        print(eq_str2)
        for i in range(len(eq)):
            print("y" + str(i + 1) + "=", round(eq[i], 3))
        # -----------------------------------------------

        # ----------Рівнняня незначимих коефіцієнтів-----
        eq = []
        ...
        print("Regression equation with excluded factors:")
        eq_str = "y= 0"
